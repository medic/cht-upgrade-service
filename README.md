...
| `NGINX_HTTP_PORT`      | no       | Defaults to 80. The port on which CHT-Api is available on the host network.                                                                                                                                                                  |
| `NGINX_HTTPS_PORT`      | no       | Defaults to 443. The secure port on which CHT-Api is available on the host network.                                                                                                                                                          |
